...
def createForm(img_name, width, height, XPOS, YPOS, data):
    ...
    frame_for_image = tkinter.Frame(frame, bg='red')
    frame_for_image.place(relx = 0, rely = 0, relwidth = 1/3,relheight = 1)
    #code for the image     
    ...
    frame_for_table.place(relx = 1/3, rely = 0, relwidth = 1/3,relheight = 2/3)
