import os
import importlib
importlib.import_module("proportion_calculator")
importlib.import_module("frontend_interface")
#from proportion_calculator import *
import frontend_interface as frontend
...
if __name__ == "__main__":
    frontend.createForm("Gioconda.jpg", width, height, XPOS, YPOS, data_fake)
